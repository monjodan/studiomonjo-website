...
(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      'shop.filterAll': 'All',
      'shop.hideSold': 'Hide sold out',
      'shop.matchOne': '1 piece',
      'shop.matchN': '{n} pieces',
      'shop.matchNone': 'Nothing matches these filters yet.',
      ...
      'essays.intro': '{count} essays on Brunch, in Korean. On consciousness, control, aesthetics, and living between languages and cultures.',
      'essays.introSingular': '{count} essay on Brunch, in Korean. On consciousness, control, aesthetics, and living between languages and cultures.',
      ...
      /* ---- editions (limited-run model) ---- */
      'editions.label': 'The shop',
      'editions.title': 'Editions.',
      'editions.lede': 'Each design is painted in a run of twenty, hand-numbered from 1 to 20. Click a piece to see the full gallery, materials, and buy options. When an edition is sold out, it\u2019s gone.',
      'editions.loading': 'Loading editions\u2026',
      'editions.empty': 'No editions yet. Check back soon.',
      'editions.empty.notebook': 'The next notebook edition is on the bench. Check back soon.',
      'editions.empty.bound-card': 'First card editions coming soon.',
      'editions.empty.carnet': 'First Le Carnet editions coming soon.',
      'editions.empty.set': 'First sets coming soon. Boxed seasonal cards and the all-formats set.',
      'editions.error': 'Could not load the editions.',
      'edition.remaining': '{count} of {total} remaining',
      'edition.soldOutPill': 'Sold out \u00B7 {sold}/{total}',

      /* ---- product detail modal ---- */
      'pdm.close': 'Close',
      'pdm.prev': 'Previous photo',
      'pdm.next': 'Next photo',
      'pdm.viewPhoto': 'View photo {n}',
      'pdm.featureLabelPaper': 'Paper',
      'pdm.featureLabelInside': 'Inside',
      'pdm.featureLabelCover': 'Cover',
      'pdm.featureLabelPaint': 'Paint',
      'pdm.featureLabelBinding': 'Binding',
      'pdm.featurePaper': 'Made for fountain pens',
      'pdm.featurePaperNote': 'no feathering, no bleed-through',
      'pdm.featureInside': '{count} pages of Iroful paper (Japan)',
      'pdm.featureInsideOne': '1 page of Iroful paper (Japan)',
      'pdm.featureCover': 'Canson paper, painted in ink & watercolour',
      'pdm.featurePaint': 'Nevskaya Palitra \u201CWhite Nights\u201D',
      'pdm.featureBinding': 'Hand-stitched with Sajou waxed linen thread (France)',
      'pdm.aboutMaterials': 'About the materials \u203A',
      'pdm.buyKorea': 'Buy in Korea \u2197',
      'pdm.buyFrance': 'Buy in France \u2197',
      'pdm.koreaSoon': 'Korea shop \u00B7 opening soon',
      'pdm.franceSoon': 'France shop \u00B7 opening soon',
      'pdm.shopsSoon': 'The shops are being set up. Check back soon.',
      'pdm.koreaSoonNote': 'Korea shop opening soon.',
      'pdm.franceSoonNote': 'France shop opening soon.',
      'pdm.availableFine': 'Each copy ships with its edition number marked inside.',
      'pdm.soldOutNotice': 'Sold out. Edition of {total} complete.',
      'pdm.soldOutFine': 'Each design is produced once, never repeated.',
    ...
    ko: {
      ...
      'shop.filterAll': '전체',
      'shop.hideSold': '판매 완료 숨기기',
      'shop.matchOne': '1점',
      'shop.matchN': '{n}점',
      'shop.matchNone': '조건에 맞는 작품이 아직 없어요.',
      ...
      'editions.label': '샵',
      'editions.title': '에디션.',
      'editions.lede': '각 디자인은 20권 한정판으로, 1번부터 20번까지 하나씩 번호를 매겨 그려요. 노트를 눌러 전체 사진과 재료, 구매 옵션을 확인해 보세요. 한 에디션이 완판되면 그 디자인은 그대로 끝이에요.',
      'editions.loading': '에디션을 불러오는 중…',
      'editions.empty': '아직 공개된 에디션이 없어요. 곧 다시 찾아 주세요.',
      'editions.empty.notebook': '다음 노트 에디션을 작업 중이에요. 곧 다시 찾아 주세요.',
      'editions.empty.bound-card': '첫 카드 에디션을 준비하고 있어요.',
      'editions.empty.carnet': '첫 르 카르네 에디션을 준비하고 있어요.',
      'editions.empty.set': '첫 세트를 준비하고 있어요. 계절 박스 카드와 올포맷 세트가 곧 나와요.',
      'editions.error': '에디션을 불러오지 못했어요.',
      'edition.remaining': '20권 중 {count}권 남음',
      'edition.soldOutPill': '판매 완료 · {sold}/{total}',

      /* ---- 상품 상세 모달 ---- */
      'pdm.close': '닫기',
      'pdm.prev': '이전 사진',
      'pdm.next': '다음 사진',
      'pdm.viewPhoto': '{n}번째 사진 보기',
      'pdm.featureLabelPaper': '종이',
      'pdm.featureLabelInside': '속지',
      'pdm.featureLabelCover': '커버',
      'pdm.featureLabelPaint': '물감',
      'pdm.featureLabelBinding': '제본',
      'pdm.featurePaper': '만년필에 맞춘 종이',
      'pdm.featurePaperNote': '번짐 없고, 뒷면 비침도 없어요',
      'pdm.featureInside': '이로풀 종이 {count}페이지 (일본)',
      'pdm.featureInsideOne': '이로풀 종이 한 장 (일본)',
      'pdm.featureCover': '캉송 종이에 잉크와 수채로 그려요',
      'pdm.featurePaint': '네브스카야 팔리트라 “White Nights”',
      'pdm.featureBinding': '사주 왁스 린넨 실로 손바느질 (프랑스)',
      'pdm.aboutMaterials': '재료 이야기 ›',
      'pdm.buyKorea': '한국에서 구매 ↗',
      'pdm.buyFrance': '프랑스에서 구매 ↗',
      'pdm.koreaSoon': '한국 스토어 · 준비 중',
      'pdm.franceSoon': '프랑스 스토어 · 준비 중',
      'pdm.shopsSoon': '스토어를 준비 중이에요. 곧 다시 찾아 주세요.',
      'pdm.koreaSoonNote': '한국 스토어는 곧 열어요.',
      'pdm.franceSoonNote': '프랑스 스토어는 곧 열어요.',
      'pdm.availableFine': '모든 노트에는 에디션 번호가 속표지에 적혀 나가요.',
      'pdm.soldOutNotice': '판매 완료. {total} 에디션이 모두 나갔어요.',
      'pdm.soldOutFine': '같은 디자인은 한 번만 그리고, 다시 만들지 않아요.',
